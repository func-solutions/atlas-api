...
fun warn(message: String): Unit = println("$ANSI_YELLOW[ATLAS] $message$ANSI_RESET")

fun log(message: String): Unit = println("$ANSI_GREEN[ATLAS] $message$ANSI_RESET")
